...
class MainWindow(object):
    def __init__(self, qApp=None):
        ...
        self.asmEdit.setPlainText(open(_resource("../test.asm")).read())
    ...
    def setupTrees(self):
        ...
        width = treeViewData.width()
        for i in range(3):
            treeViewData.setColumnWidth(i, width // 3)
    ...
    def saveAction(self):
        ...
        filename = QFileDialog().getSaveFileName(
            self.gui, "Save file", filter="*.asm", initialFilter="*.asm"
        )[0]
